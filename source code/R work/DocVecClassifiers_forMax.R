...
#import data
data <- read.csv('C:/Users/Norbert/Desktop/TWE output/minMaxDoc_dim200.csv', header = TRUE)[samp,]
...
# Predciting SVM
svm_linear2 <- readRDS("C:/Users/Norbert/Desktop/Honours/R codes/classifier models/minMax200_SVM.rds")
pred_svm_1 <- predict(svm_linear2, xTest)
confusionMatrix(data = pred_svm_1 , reference = yTest)

# LibLineaR predictions
libLinModel <- readRDS("C:/Users/Norbert/Desktop/Honours/R codes/classifier models/minMax200_LiblineaR.rds")
predictions <- predict(libLinModel, as.matrix(xTest))
confusionMatrix(data = predictions$predictions, reference = yTest)

# Predicting LDA
ldamod_linkage2 <- readRDS("C:/Users/Norbert/Desktop/Honours/R codes/classifier models/minMax200_LDA.rds")
pred_lda_1 <- predict(ldamod_linkage2, newdata = xTest)
confusionMatrix(data = pred_lda_1$class, reference = yTest)

# Predicting QDA
qdamod_linkage2 <- readRDS("C:/Users/Norbert/Desktop/Honours/R codes/classifier models/minMax200_QDA.rds")
...
train2RF <- readRDS("C:/Users/Norbert/Desktop/Honours/R codes/classifier models/minMax200_randomForest.rds")
pred_RF<- predict(train2RF, xTest)
confusionMatrix(data = pred_RF, reference = yTest)

# Gradient Boosting predictions
grBoostFit_linkage2 <- readRDS("C:/Users/Norbert/Desktop/Honours/R codes/classifier models/minMax200_grBoosting.rds")
