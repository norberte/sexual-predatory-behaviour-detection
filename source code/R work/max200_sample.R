...
data <- read.csv("maxDoc_dim200.csv", header = TRUE)[sam,]
...
#summary(svm_linear2)
#saveRDS(svm_linear2, "max200_svm.rds")
...
saveRDS(grBoostFit_linkage2, "max200_grBoosting.rds")
