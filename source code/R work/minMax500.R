...
minMax500 <- read.csv("minMaxDoc_dim500.csv", header = TRUE)

train <-sample(1:dim(minMax500)[1],100000)

xTrain <- minMax500[train,]
xTest <- minMax500[-train,]
print("imported data ...")
yTrain <- labels[train,]
yTest <- labels[-train,]
...
summary(svm_linear2)
saveRDS(svm_linear2, "minMax500_svm.rds")
...
saveRDS(grBoostFit_linkage2, "minMax500_grBoostingmax500_grBoosting.rds")
